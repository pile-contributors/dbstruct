...
/* ------------------------------------------------------------------------- */
/* ========================================================================= */
#ifndef __%(NAMESPACE)s_DB_%(DATABASE)s_TABLE_%(TABLE)s_META_INC__
#define __%(NAMESPACE)s_DB_%(DATABASE)s_TABLE_%(TABLE)s_META_INC__
//
//
//
//
...
#endif // __%(NAMESPACE)s_DB_%(DATABASE)s_TABLE_%(TABLE)s_META_INC__
/* ------------------------------------------------------------------------- */
/* ========================================================================= */
