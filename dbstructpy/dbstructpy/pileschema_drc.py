...
class pile_sch_tables(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, pile_sch_tables)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if pile_sch_tables.subclass:
            return pile_sch_tables.subclass(*args_, **kwargs_)
        else:
            return pile_sch_tables(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dbsm:', name_='tables', namespacedef_='xmlns:dbsm="http://pile-contributors.github.io/trunk/dbstruct.xsd"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class pile_sch_tables


class pile_sch_views(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, pile_sch_views)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if pile_sch_views.subclass:
            return pile_sch_views.subclass(*args_, **kwargs_)
        else:
            return pile_sch_views(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dbsm:', name_='views', namespacedef_='xmlns:dbsm="http://pile-contributors.github.io/trunk/dbstruct.xsd"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class pile_sch_views


class pile_sch_bootstrap(GeneratedsSuper):
    """Describes the way this database should be prepared for first run."""
    member_data_items_ = {
    }
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, pile_sch_bootstrap)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if pile_sch_bootstrap.subclass:
            return pile_sch_bootstrap.subclass(*args_, **kwargs_)
        else:
            return pile_sch_bootstrap(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dbsm:', name_='bootstrap', namespacedef_='xmlns:dbsm="http://pile-contributors.github.io/trunk/dbstruct.xsd"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='bootstrap')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dbsm:', name_='bootstrap', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dbsm:', name_='bootstrap'):
        pass
    def exportChildren(self, outfile, level, namespace_='dbsm:', name_='bootstrap', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class pile_sch_bootstrap


class pile_sch_database(GeneratedsSuper):
    """Describes a database structure."""
    member_data_items_ = {
        'tables': MemberSpec_('tables', 'tables', 0),
        'views': MemberSpec_('views', 'views', 0),
        'bootstrap': MemberSpec_('bootstrap', 'bootstrap', 0),
    }
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, pile_sch_database)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if pile_sch_database.subclass:
            return pile_sch_database.subclass(*args_, **kwargs_)
        else:
            return pile_sch_database(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_tables(self): return self.tables
    def set_tables(self, tables): self.tables = tables
    tablesProp = property(get_tables, set_tables)
    def get_views(self): return self.views
    def set_views(self, views): self.views = views
    viewsProp = property(get_views, set_views)
    def get_bootstrap(self): return self.bootstrap
    def set_bootstrap(self, bootstrap): self.bootstrap = bootstrap
    bootstrapProp = property(get_bootstrap, set_bootstrap)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dbsm:', name_='database', namespacedef_='xmlns:dbsm="http://pile-contributors.github.io/trunk/dbstruct.xsd"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='dbsm:', name_='database', fromsubclass_=False, pretty_print=True):
        ...
        if self.bootstrap is not None:
            self.bootstrap.export(outfile, level, namespace_, name_='bootstrap', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tables':
            obj_ = pile_sch_tables.factory()
            obj_.build(child_)
            self.tables = obj_
            obj_.original_tagname_ = 'tables'
        elif nodeName_ == 'views':
            obj_ = pile_sch_views.factory()
            obj_.build(child_)
            self.views = obj_
            obj_.original_tagname_ = 'views'
        elif nodeName_ == 'bootstrap':
            obj_ = pile_sch_bootstrap.factory()
            obj_.build(child_)
            self.bootstrap = obj_
            obj_.original_tagname_ = 'bootstrap'
# end class pile_sch_database
...
USAGE_TEXT = """
Usage: python <pile_sch_Parser>.py [ -s ] <in_xml_file>
"""
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from pileschema_drc import *\n\n')
        sys.stdout.write('import pileschema_drc as model_\n\n')
